    ...
    <ThemeProvider>
      <div className="min-h-screen bg-background text-foreground overflow-hidden">
        ...
        <div className="fixed inset-0 pointer-events-none z-0">
          <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-gradient-to-b dark:from-apple-blue/5 from-apple-blue/10 dark:to-transparent to-transparent rounded-full blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-gradient-to-t dark:from-apple-indigo/5 from-apple-indigo/10 dark:to-transparent to-transparent rounded-full blur-3xl"></div>
          <div 
            className="absolute inset-0 dark:opacity-[0.01] opacity-[0.02]" 
            style={{ 
            ...
            {showEvaluation && (
              ...
              >
                <div className="card-github p-6 md:p-8 shadow-lg"> 
                  <h2 className="text-2xl md:text-3xl font-medium mb-8 dark:text-white text-gray-900">
